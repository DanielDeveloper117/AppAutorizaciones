    ...
    useEffect(() => {
        ...
        switch(queryProp) {
            case "Autorizados":
                setVerDetalle(false);
                setIdDetalle(0);
                url = 'http://187.189.75.29:3000/api/autorizados';
            ...
            case "AutorizadosGerentes":
                setVerDetalle(false);
                setIdDetalle(0);
                url = 'http://187.189.75.29:3000/api/autorizados/gerentes';
                console.log('query es: ', queryProp);
            ...
            case "ordenesCompra":
                setIdDetalle(0);
                setVerDetalle(false);
                url = 'http://187.189.75.29:3000/api/autorizados/oc';
                console.log('es oc');
                break;
            ...
            case "ordenesCompraGerentes":
                setIdDetalle(0);
                setVerDetalle(false);
                url = 'http://187.189.75.29:3000/api/autorizados/oc/gerentes';
            ...
            case "solicitudesGastos":
                setIdDetalle(0);
                setVerDetalle(false);
                url = 'http://187.189.75.29:3000/api/autorizados/sg';
                console.log('es sg');
                break;
            ...
            case "solicitudesGastosGerentes":
                setIdDetalle(0);
                setVerDetalle(false);
                url = 'http://187.189.75.29:3000/api/autorizados/sg/gerentes';
